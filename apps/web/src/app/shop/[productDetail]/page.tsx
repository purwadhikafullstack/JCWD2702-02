        ...
        <div className='mt-[20px] flex flex-col gap-[10px] lg:mt-[60px] lg:w-[55%]'>
          <div className='mb-4 flex flex-col'>
            ...
            <div className='mt-4 flex items-center gap-10'>
              ...
              <button
                className='flex h-[30px] w-[200px] items-center justify-center gap-5 rounded-md border-2 border-eggplant bg-eggplant text-[14px] font-medium text-white hover:border-hover_eggplant hover:bg-hover_eggplant lg:h-[40px] lg:text-[16px]'
                onClick={() =>
                  mutationAddToCart({
