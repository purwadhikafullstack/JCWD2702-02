...
export default function AdminProductCard({ id, name, price, productImage }: IAdminProductCard) {
    return (
        <Link href={`/admin/product/${id}`} passHref>
            <div className="border border-gray-300 rounded-lg shadow-lg p-4 m-2 flex flex-col items-center w-full h-full">
                <Image src={productImage} alt={name} className="rounded-md mb-4 object-cover w-[70%] h-[70%]" width={150} height={150} />
